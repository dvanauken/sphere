...
import { LONDON, TOKYO, MOUNT_EVEREST } from '../../__fixtures__/coordinates.js';
describe('Coordinate', () => {
    ...
    describe(TEST_CATEGORIES.REAL_WORLD, () => {
        it('should correctly represent London coordinates', () => {
            assertCoordinateNearlyEqual(LONDON, new Coordinate(51.5074, -0.1278));
        });
        it('should correctly represent Tokyo coordinates', () => {
            assertCoordinateNearlyEqual(TOKYO, new Coordinate(35.6762, 139.6503));
        });
    });
});

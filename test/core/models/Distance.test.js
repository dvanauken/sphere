...
import { ONE_KILOMETER, ONE_MILE, LONDON_TO_PARIS } from '../../__fixtures__/distances.js';
describe('Distance', () => {
    ...
    describe(TEST_CATEGORIES.REAL_WORLD, () => {
        it('should calculate London to Paris distance', () => {
            assertDistanceNearlyEqual(LONDON_TO_PARIS, Distance.fromKilometers(344), 1000 // 1km tolerance for real-world distance
            );
        });
    });

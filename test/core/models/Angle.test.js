...
import { RIGHT_ANGLE, STRAIGHT_ANGLE, FULL_CIRCLE, EQUILATERAL, NEGATIVE, OVER_360 } from '../../__fixtures__/angles.js';
describe('Angle', () => {
    ...
    describe('Static Methods', () => {
        it('should define angle using Law of Sines', () => {
            ...
            const angleA = Angle.defineBy(Arc.onSphere(), Arc.onSphere(), angleC, arcA, arcB, arcC);
        ...
        it('should define angle using Law of Cosines', () => {
            ...
            const angleC = Angle.defineBy(Arc.onSphere(), Arc.onSphere(), Arc.onSphere(), arcA, arcB, arcC);
            // Verify using Law of Cosines formula
            const cosC = (Math.pow(arcA.inMeters(), 2) +
                Math.pow(arcB.inMeters(), 2) -
                Math.pow(arcC.inMeters(), 2)) / (2 * arcA.inMeters() * arcB.inMeters());

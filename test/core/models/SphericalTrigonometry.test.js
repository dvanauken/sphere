...
import { RIGHT_ANGLE, EQUILATERAL } from '../../__fixtures__/angles.js';
describe('SphericalTrigonometry', () => {
    describe('Law of Cosines', () => {
        it('should calculate third side of right triangle', () => {
            ...
            const arcC = SphericalTrigonometry.lawOfCosines(arcA, arcB, angleC);
            // For right triangle, c² ≈ a² + b² for small triangles
            const expectedC = Math.sqrt(Math.pow(arcA.inMeters(), 2) +
    ...
    describe('Law of Sines', () => {
        it('should calculate side using known angle and side', () => {
            ...
            const arcA = SphericalTrigonometry.lawOfSines(angleA, angleB, arcC);

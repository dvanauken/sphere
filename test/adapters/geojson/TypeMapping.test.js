...
describe('TypeMapping', () => {
    ...
    describe('Registration', () => {
        ...
        it('should throw error for invalid GeoJSON type', () => {
            ...
            expect(() => {
                TypeMapping.registerMapping(CustomType, invalidType);
            }).toThrow();
        });
    ...
    describe(TEST_CATEGORIES.EDGE_CASES, () => {
        it('should handle undefined type registration', () => {
            expect(() => {
                TypeMapping.registerMapping(undefined, { type: "Point", coordinates: [] });
            }).toThrow();
        });
        it('should handle null type registration', () => {
            expect(() => {
                TypeMapping.registerMapping(null, { type: "Point", coordinates: [] });
            }).toThrow();
        });
        it('should handle registration with empty GeoType', () => {
            ...
            expect(() => {
                TypeMapping.registerMapping(CustomType, {});
            }).toThrow();
        });
    });
